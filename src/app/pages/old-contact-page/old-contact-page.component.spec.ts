...
import { OldContactPageComponent } from './old-contact-page.component';
import { NO_ERRORS_SCHEMA } from '@angular/core';
import { ReactiveFormsModule } from '@angular/forms';

describe('ContactPageComponent', () => {
  let component: OldContactPageComponent;
  let fixture: ComponentFixture<OldContactPageComponent>;
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [ReactiveFormsModule],
      declarations: [OldContactPageComponent],
      schemas: [NO_ERRORS_SCHEMA],
    }).compileComponents();

    fixture = TestBed.createComponent(OldContactPageComponent);
